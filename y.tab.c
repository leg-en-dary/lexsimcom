...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from simcomsta.y  */
...
const int YY_parse_CLASS::DOT=258;
const int YY_parse_CLASS::compound=259;
const int YY_parse_CLASS::word=260;
...
static const char * const yytname[] = {   "$","error","$illegal.","DOT","compound",
"word","s1","s","wordlist",""
};
#endif
...
static const short yypact[] = {     0,
     0,     0,    -2,-32768,-32768,-32768,     0,     1,-32768,     3,
     7,-32768
};
